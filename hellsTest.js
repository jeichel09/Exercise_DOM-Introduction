function onClick (info) {
    ...
    console.log(`Name: ${results[bestInd - 1]} Average Salary: ${results[bestInd].toFixed(2)} Best Salary: ${results[bestInd + 1].toFixed(2)}`);
...
onClick('["Mikes - Steve 1000, Ivan 200, Paul 800","Fleet - Maria 850, Janet 650","Mikes - Sasho 1200, Petkan 2100"]\n');